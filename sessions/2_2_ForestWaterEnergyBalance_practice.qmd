...
![](resources/img/Escher_nightday.jpg)
:::
:::::
...
```{r, echo = TRUE}
x_adv <- forest2spwbInput(exampleforest, examplesoil, SpParamsMED, control)
```
...
```{r, echo = TRUE, fig=TRUE, fig.align="center", fig.width=8, fig.height = 3.5}
