...
+ Day 1 (~ 4.5h including 30-min break and 1h exercises): 
  ...
  - Introduction to the *medfate* R package
  - Generating model inputs
+ Day 2 (~ 5h including 30-min break and 1h exercises)
  - Design and formulation of forest water/energy balance in *medfate*
  - Running water/energy balance simulations with function *spwb()*
+ Day 3 (~ 5h including 30-min break and 1h30min exercises): 
  - Design and formulation of forest carbon balance and forest dynamics in *medfate*
  - Running simulations of carbon balance and forest dynamics with functions *growth()* and *fordyn()*
+ Day 4 (~ 4h including 30-min break):
  - Large-scale simulations: parameterization, initialization and climate forcing
