...
```{r, fig=TRUE, fig.align="center", fig.width=12, fig.height = 4}
g1<-plot(sd1, type = "LeafTranspiration", bySpecies = TRUE)
g2<-plot(sd1, type = "LeafGrossPhotosynthesis", bySpecies = TRUE)
