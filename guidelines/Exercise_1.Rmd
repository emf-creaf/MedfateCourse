...
16. Build an object of the S4 class `SpatialPointsTopography` (defined in package **meteoland**), containing the `SpatialPoints` of Step 12 and the topographic variables (elevation, slope, aspect).
