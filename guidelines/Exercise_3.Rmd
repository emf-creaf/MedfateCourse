...
9. Compare the final `forest` state with the one derived from SNFI4. Is the final stand density and basal area predicted acceptably? What about shrub cover?
 
```{r}

```
 
10. Predict future forest dynamics using weather projection data frame included in the data. Use the previous run of `fordyn()` as starting point for simulations.
