...
When stomata are open, a larger transpiration flow (*E*) implies (in steady state) a larger drop in water potential along the transpiration pathway [^1]:

[^1]: Venturas et al. (2017). J. Int. Pl. Biol., 59, 356-389.
...
[^1]: Fatichi et al. (2016). WIRE: Water, 3, 327-368.
...
::::: columns
::: {.column width="60%"}
Maximum canopy transpiration $Tr_{\max}$ depends on potential evapotranspiration, $PET$, and the amount of transpirating surface, i.e. the stand leaf area index, thanks to: $$\frac{Tr_{\max}}{PET}= -0.006\cdot (LAI^{\phi}_{stand})^2+0.134\cdot LAI^{\phi}_{stand}$$
...
$$Tr_{s} =  Tr_{\max} \cdot K(\Psi_{s}) \cdot FRP_{s}$$ where $FRP_{s}$ is the proportion of plant fine roots in layer $s$.
...
[^1]: Sperry et al. (1998) Plant, Cell & Env., 21, 347-359
[^2]: Sperry et al. (2017) Plant, Cell & Env., 40, 816-830
[^3]: Ruffault et al. (2022) Geosci. Mod. Dev., 15, 5593-5626
...
[^1]: Ruffault et al. (2022) Geosci. Mod. Dev., 15, 5593-5626
...
[^2]: Baldocchi D. (1994) Tree Phys., 14, 1069-1079
