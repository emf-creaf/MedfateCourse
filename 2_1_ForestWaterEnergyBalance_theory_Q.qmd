...
+ **Hydraulic conductance** $k$ is used to measure how much flow exists along a pathway segment (e.g. soil, stem, leaves, ... ) for a given difference in water potential.

+ Hydraulic conductance decreases when **air replaces water** in any segment.

+ **Vulnerability curve** specifies the relationship between water potential, $\Psi$, and hydraulic conductance, $k$, of a given segment. 
...
![](resources/img/vulnerability_curves.png){width="60%"}
...
| Process | Source |
|---------|-----------|
| Soil & canopy energy balance | *Best et al. (2011)* |
| Canopy turbulence | *Katul et al. (2004)* |
| Sunlit/shade leaf photosynthesis | *De pury & Farquhar (1997)* |
| Direct/diffuse short-wave extinction model | *Anten & Bastiaans (2016)* |
| Long-wave radiation model | *Flerchinger et al. (2009)*|
...
+ **Steady-state** plant hydraulics (*Sperry et al. 1998*).
+ Optimality-based stomatal regulation (*Sperry et al. 2017*).
...
+ Plant hydraulics of **SurEau-ECOS** (*Ruffault et al., 2022*),
including plant water storage.
+ Stomatal regulation based on a Baldocchi-type model.
:::
...
*Sperry et al. (1998). Plant, Cell & Env., 21, 347-359.*
:::
...
Stomatal regulation can be effectively estimated by determining the maximum of the *profit function*:
...
Water dynamics in SurEau-ECOS are governed by **partial differential equations** of mass conservation (*Ruffault et al 2022*):
...
Stomatal conductance takes into account the dependence of stomata on light and temperature, as well as leaf water status: 

$$g_{sw} = g_{sw, light, temp} \cdot \lambda(\Psi_{leaf,sym}) $$

where $g_{sw, light, temp}$ is the stomatal conductance value without water stress (*Baldocchi 1994*), and $\lambda$ is a regulation factor that represents stomatal closure according to leaf water potential, using a sigmoid function.
