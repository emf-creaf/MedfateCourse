...
## Leaf area/sapwood/fine root biomass growth
...
$$\Delta B_{fineroot} = \min( \Delta B_{fineroot,alloc}, \Delta B_{fineroot,source}, \Delta B_{fineroot,sink})$$
   ...
   1. $\Delta LA_{alloc}$, $\Delta SA_{alloc}$  and $\Delta B_{fineroot,alloc}$ are the increments allowed according to the targets set by **allocation rules**.
